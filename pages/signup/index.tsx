  ...
  const SignupWithMail = () => {
    ...
    return (
      <div className='d-flex column flex-gap20 mt-20'>
        ...
        <MaterialTextField variant="outlined" name="confirm-password" placeholder='Confirm your password' />

        <Link className='max-w-320' href={'/terms'}>
          By continuing you agree to the  <span className='text-link'>Term of Service and Privacy Policy</span>
        </Link>
